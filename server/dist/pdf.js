...
export function sendPdf(res, filename, build) {
...
export function title(doc, text) {
    doc.fontSize(18).font('Helvetica-Bold').text(text, { align: 'left' });
    doc.moveDown(0.6);
}
export function kv(doc, label, value) {
...
export function tableHeader(doc, cols, widths) {
...
export function tableRow(doc, vals, widths) {
